...
class MPin:
    ...
    def digital_read(self) -> Optional[int]:
        """读取当前引脚的数字信号值（0 或 1）"""
        ...

    def digital_write(self, value: int) -> None:
        """
        向当前引脚写入数字电平值
        Args:
    ...
    def analog_read(self) -> Optional[int]:
        """读取当前引脚的模拟输入值（0 ~ 4095）"""
        ...

    def analog_write(self, duty: int, freq: int = 1000) -> None:
        """
    ...
    def analog_write_u16(self, duty: int, freq: int = 1000) -> None:
        """
